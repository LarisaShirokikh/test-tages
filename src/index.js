...
const outputFilePath = 'output.txt'; // Путь к выходному отсортированному файлу
const availableMemory = 500 * 1024 * 1024; // 500 МБ доступной памяти
// Функция для сортировки и записи части данных в файл
...
// Функция для объединения отсортированных частей в итоговый отсортированный файл
...
// Чтение исходного файла, разделение на части и их сортировка
